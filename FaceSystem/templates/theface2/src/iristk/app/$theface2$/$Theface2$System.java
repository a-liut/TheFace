...
public class $Theface2$System {
		
	public $Theface2$System() throws Exception {
		...
		system.addModule(new FlowModule(new $Theface2$Flow(systemAgentFlow)));
		system.loadContext("default", new SpeechGrammarContext(new SRGSGrammar(system.getPackageFile("$Theface2$Grammar.xml"))));
